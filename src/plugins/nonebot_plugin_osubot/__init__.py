...
add_model('src.plugins.nonebot_plugin_osubot.database.models')
...
recent = on_command("!recent", aliases={'！recent','!re','！re'} , priority=5, block=True)
...
pr = on_command("!pr",aliases={'！pr'}, priority=5, block=True)
...
bp = on_command('!bp', aliases={'！bp'} , priority=5, block=True)
...
pfm = on_command('!pfm', aliases={'！pfm'} , priority=5, block=True)
...
osu_map = on_command('!map',aliases={'！map'} , priority=5, block=True)
...
bmap = on_command('!bmap',aliases={'！bmap'} , priority=5, block=True)
...
osudl = on_command('!osudl',aliases={'！osudl'} , priority=5, block=True)
...
unbind = on_command('!unbind',aliases={'！unbind'} , priority=5, block=True)
...
update = on_command('!update',aliases={'！update'} , priority=5, block=True)
...
getbg = on_command('!getbg',aliases={'！getbg'} , priority=5, block=True)
...
generate_full_ln = on_command('!反键', aliases={'！反键'}, priority=5, block=True)
...
generate_preview = on_command('!preview', aliases={'！preview'}, priority=5, block=True)
...
update = on_command('!更新', priority=5, block=True)
...
recommend = on_command('!recommend', aliases={'!推荐', '！recommend', '！推荐'}, priority=5, block=True)
