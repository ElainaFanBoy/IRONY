...
plugin_help = on_command("塔罗牌帮助", permission=GROUP|PRIVATE, priority=4, block=True)
tarot = on_command("塔罗牌", permission=GROUP|PRIVATE, priority=4, block=True)
divine = on_command("占卜", permission=GROUP|PRIVATE, priority=4, block=True)
